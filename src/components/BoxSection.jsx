    ...
    <>
      ...
      <div className="d-flex justify-content-between box-section mb-4">
        <div
          ...
          className="border box border-dark d-flex"
        >
          <div>
            <h2 style={{ backgroundColor: "white", marginTop: "30px" }}>
      ...
      <div className="d-flex justify-content-between box-section mb-4 ">
        ...
        >
          <div>
            ...
            <div style={{ marginTop: "180px" }}>
              <i class="fa-solid text-light fa-share"></i>{" "}
              <a
        ...
        >
          <div>
            <h2 style={{ backgroundColor: "#B9FF66", marginTop: "30px" }}>
              Email marketing
            </h2>
            <div style={{ marginTop: "180px" }}>
              <i class="fa-solid fa-share"></i>{" "}
      ...
      <div className="d-flex justify-content-between box-section mb-4">
        ...
        >
          <div>
            <h2 style={{ backgroundColor: "#B9FF6", marginTop: "30px" }}>
